---
slug: docs/design/platform-gallery-handoff/design
title: DESIGN
...
Source: `docs/design/platform-gallery-handoff/DESIGN.md` (excerpt; secrets redacted).
...
- `assets/framerusercontent_com/images/*` - 3D cube visuals, product images, device imagery, icons, article th
