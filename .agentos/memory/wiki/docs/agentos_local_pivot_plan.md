---
slug: docs/agentos_local_pivot_plan
title: AGENTOS LOCAL PIVOT PLAN
...
Source: `docs/AGENTOS_LOCAL_PIVOT_PLAN.md` (excerpt; secrets redacted).
...
- Full runtime migration of lower-churn admin/dev flows away from snapshot-style
