---
slug: flows/cursor-memory
title: Cursor memory flow
tags: [cursor, memory, flow]
...
- **Working now?** → [[sessions/cursor/agent-613a4d6a-e2d4-40c7-b4c0-b45fc5b48924]]
- **You are working inside the AgentOS repository in Cursor. Your job is to implement a premium AgentOS ** → [[sessions/cursor/49de712f-f8ab-41ac-af48-5827eb232388]]
- **all other chats on this repositories have or are working on pushing their git commits. summarize wha** → [[sessions/cursor/bd095a93-d3b4-479b-a8ba-bfd6875485f0]]
- **You are Claude running inside Cursor on my AgentOS repo. Your first job is orientation only. Do not ** → [[sessions/cursor/22a11abf-e2eb-4160-b02d-65c2c0fa3586]]
