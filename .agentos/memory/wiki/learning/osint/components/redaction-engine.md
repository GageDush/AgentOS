---
slug: learning/osint/components/redaction-engine
...
Source: `apps/command-center/src/content/docs/components/redaction-engine.md` — full body indexed for agent retrieval.
Canonical human reader: `/docs/components/redaction-engine` (flous.dev/docs).
