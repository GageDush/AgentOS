---
slug: learning/osint/components/entity-resolver
...
Source: `apps/command-center/src/content/docs/components/entity-resolver.md` — full body indexed for agent retrieval.
Canonical human reader: `/docs/components/entity-resolver` (flous.dev/docs).
