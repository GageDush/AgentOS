---
slug: learning/osint/adapters/dns
title: Dns
...
Source: `apps/command-center/src/content/docs/adapters/dns.md` — full body indexed for agent retrieval.
Canonical human reader: `/docs/adapters/dns` (flous.dev/docs).
