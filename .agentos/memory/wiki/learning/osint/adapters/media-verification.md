---
slug: learning/osint/adapters/media-verification
...
Source: `apps/command-center/src/content/docs/adapters/media-verification.md` — full body indexed for agent retrieval.
Canonical human reader: `/docs/adapters/media-verification` (flous.dev/docs).
