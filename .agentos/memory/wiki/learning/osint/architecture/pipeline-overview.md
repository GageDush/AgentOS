---
slug: learning/osint/architecture/pipeline-overview
...
Source: `apps/command-center/src/content/docs/architecture/pipeline-overview.md` — full body indexed for agent retrieval.
Canonical human reader: `/docs/architecture/pipeline-overview` (flous.dev/docs).
