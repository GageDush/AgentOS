---
slug: learning/osint/architecture/source-adapters
...
Source: `apps/command-center/src/content/docs/architecture/source-adapters.md` — full body indexed for agent retrieval.
Canonical human reader: `/docs/architecture/source-adapters` (flous.dev/docs).
