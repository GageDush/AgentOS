---
slug: learning/osint/architecture/correlation
title: Correlation
...
Source: `apps/command-center/src/content/docs/architecture/correlation.md` — full body indexed for agent retrieval.
Canonical human reader: `/docs/architecture/correlation` (flous.dev/docs).
