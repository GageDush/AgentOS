---
slug: learning/osint/architecture/storage
title: Storage
...
Source: `apps/command-center/src/content/docs/architecture/storage.md` — full body indexed for agent retrieval.
Canonical human reader: `/docs/architecture/storage` (flous.dev/docs).
