---
slug: learning/osint/architecture/entity-model
title: Entity Model
...
Source: `apps/command-center/src/content/docs/architecture/entity-model.md` — full body indexed for agent retrieval.
Canonical human reader: `/docs/architecture/entity-model` (flous.dev/docs).
