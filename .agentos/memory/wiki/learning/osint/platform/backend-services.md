---
slug: learning/osint/platform/backend-services
...
Source: `apps/command-center/src/content/docs/platform/backend-services.md` — full body indexed for agent retrieval.
Canonical human reader: `/docs/platform/backend-services` (flous.dev/docs).
