---
slug: learning/osint/platform/data-model
title: Data Model
...
Source: `apps/command-center/src/content/docs/platform/data-model.md` — full body indexed for agent retrieval.
Canonical human reader: `/docs/platform/data-model` (flous.dev/docs).
