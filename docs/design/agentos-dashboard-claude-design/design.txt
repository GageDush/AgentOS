...
The dashboard is complete enough when:

- the active mission is obvious
- approvals are visible and actionable
- runtime health is scannable
- recent activity reads like useful audit history
- agents and sessions feel connected to the active work
- empty states are intentional
- mobile keeps the same workflows

## Required Screens

Design the dashboard route first.

Support the surrounding base routes enough that navigation feels complete:
...
The dashboard should be the strongest and most complete screen.
